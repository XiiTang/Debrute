...
Debrute 是一个本地创意生产工作台，面向 AI agent 生成的文件：图片、视频、音频、文档、设计参考，以及未来的 3D 资产。
...
在未来很长一段时间里，AI 生成都无法完全替代专业编辑工具的精度、控制力和专业经验。凡是这些专业工具已经擅长的能力，Debrute 都会刻意避免重复实现。对于专业设计师来说，Debrute 是用来生成、收集、查看、对比和挑选资源的地方，然后再把选中的资产带入专业软件继续处理。Debrute 已经包含并计划继续制作更多插件，让设计师更顺畅地在 Debrute 和专业工具之间移动资产。
...
当前仓库已经包含 Photoshop 插件相关工作，路线图也包括更多专业工具插件和交接路径。
...
- 支持更多二进制资产类型的丰富预览。
- 更多面向专业创意工具的插件。
- Debrute、本地项目文件夹和专业编辑器之间更顺畅的交接路径。
