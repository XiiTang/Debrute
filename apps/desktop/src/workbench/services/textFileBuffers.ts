import type { ProjectTextFile } from '@axis/app-protocol';
import type { TextFileBuffer } from '../../types';

export function textBufferFromFile(file: ProjectTextFile, current: TextFileBuffer | undefined): TextFileBuffer {
