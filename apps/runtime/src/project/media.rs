...
const PROJECT_CONTENT_TYPES: &[ProjectContentType] = &[
    ...
    content_type(&["mov", "qt"], &["video/quicktime"], CanvasMediaKind::Video),
    content_type(&["mkv"], &["video/x-matroska"], CanvasMediaKind::Video),
    content_type(&["ogv"], &["video/ogg"], CanvasMediaKind::Video),
    content_type(&["avi"], &["video/x-msvideo"], CanvasMediaKind::Video),
    content_type(
        &["mpg", "mpeg", "mpe", "m1v", "m2v", "vob"],
        &["video/mpeg"],
        CanvasMediaKind::Video,
    ),
    content_type(&["mts", "m2ts"], &["video/mp2t"], CanvasMediaKind::Video),
    content_type(&["flv"], &["video/x-flv"], CanvasMediaKind::Video),
    content_type(&["wmv"], &["video/x-ms-wmv"], CanvasMediaKind::Video),
    content_type(&["asf"], &["video/x-ms-asf"], CanvasMediaKind::Video),
    content_type(&["3gp"], &["video/3gpp"], CanvasMediaKind::Video),
    content_type(&["3g2"], &["video/3gpp2"], CanvasMediaKind::Video),
