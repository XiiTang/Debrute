...
fn owns_request_response_error_and_artifact_contract() {
    let mut arguments = Map::from_iter([
        ...
        ("voice".to_owned(), json!("nova")),
    ]);
    let sentinel_key = "future_contract_sentinel_openai_tts_1_hd";
    let sentinel_value = "future-contract-sentinel::openai-tts-1-hd";
    ...
    assert_first_request_preserves_remote_error(
        ...
        fixture_remote_json_error(
            422,
            &json!({
                "code": "fixture-openai_tts_1_hd-invalid-request",
                "message": "openai_tts_1_hd exact Model rejected the fixture request"
            }),
        ),
        &[
            "fixture-openai_tts_1_hd-invalid-request",
            "openai_tts_1_hd exact Model rejected the fixture request",
        ],
    );
