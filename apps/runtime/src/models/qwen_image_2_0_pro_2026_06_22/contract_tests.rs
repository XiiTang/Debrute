...
fn owns_request_response_error_and_artifact_contract() {
    ...
    let sentinel_key = "future_contract_sentinel_qwen_image_2_0_pro_2026_06_22";
    let sentinel_value = "future-contract-sentinel::qwen-image-2.0-pro-2026-06-22";
    ...
    assert_first_request_preserves_remote_error(
        ...
        fixture_remote_json_error(
            422,
            &json!({
                "code": "fixture-qwen_image_2_0_pro_2026_06_22-invalid-request",
                "message": "qwen_image_2_0_pro_2026_06_22 exact Model rejected the fixture request"
            }),
        ),
        &[
            "fixture-qwen_image_2_0_pro_2026_06_22-invalid-request",
            "qwen_image_2_0_pro_2026_06_22 exact Model rejected the fixture request",
        ],
    );
    ...
    let (execution, requests) = run_fixture(
        ...
        vec![
            fixture_json(
                &json!({"output": {"choices": [{"message": {"content": [{"image": "https://media.example/qwen-pro.png"}]}}]}}),
            ),
    ...
    assert_public_download_request(&requests[1], "https://media.example/qwen-pro.png");
}
