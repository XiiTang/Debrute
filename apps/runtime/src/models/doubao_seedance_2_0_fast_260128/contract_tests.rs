...
fn owns_request_response_error_and_artifact_contract() {
    let mut arguments = Map::from_iter([
        ("prompt".to_owned(), json!("fast pan")),
        ("intent".to_owned(), json!("generate")),
    ]);
    let sentinel_key = "future_contract_sentinel_doubao_seedance_2_0_fast_260128";
    let sentinel_value = "future-contract-sentinel::doubao-seedance-2-0-fast-260128";
    ...
    assert_first_request_preserves_remote_error(
        ...
        fixture_remote_json_error(
            422,
            &json!({
                "code": "fixture-doubao_seedance_2_0_fast_260128-invalid-request",
                "message": "doubao_seedance_2_0_fast_260128 exact Model rejected the fixture request"
            }),
        ),
        &[
            "fixture-doubao_seedance_2_0_fast_260128-invalid-request",
            "doubao_seedance_2_0_fast_260128 exact Model rejected the fixture request",
        ],
    );
