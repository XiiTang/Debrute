...
optional array. These arguments use omission rather than `null`; the Model
definition does not accept the current erroneous string or nullable alternatives.
...
```json
{
  "model": "wan2.7-image",
  "arguments": {
    "prompt": "A quiet Jiangnan canal town in misty morning light"
  },
  "output": {
    "directory": "generated",
    "name": "image"
