//! Persistent Model Request redaction before provenance and diagnostic storage.
...
pub(crate) fn redact_model_request_value(
...
mod tests {
    ...
    #[test]
    fn persistent_model_requests_remove_secrets_urls_and_inline_media() {
        ...
        let redacted = redact_model_request_value(&value, ["live-secret".to_owned()]);
    ...
    #[test]
    fn persistent_model_requests_remove_overlapping_secrets_cookies_and_embedded_urls() {
        let value = serde_json::json!({
            "cookie": "session=live",
        ...
        let redacted = redact_model_request_value(
            &value,
