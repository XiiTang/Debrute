...
export type CanvasTextSurfaceCssVariable =
  ...
  | '--canvas-text-editor-content-padding-block'
...
export function canvasTextSurfaceCssVariables(): Record<CanvasTextSurfaceCssVariable, string> {
  return {
    ...
    '--canvas-text-editor-content-padding-block': `${CANVAS_TEXT_SURFACE_METRICS.contentPaddingBlockPx}px`,
