...
import { SendToPhotoshopDialog } from './SendToPhotoshopDialog.js';
import { I18nProvider } from '../i18n/index.js';

describe('SendToPhotoshopDialog', () => {
  it('lists only linked Photoshop clients and disables no-document clients', () => {
    const html = renderToStaticMarkup(
      React.createElement(I18nProvider, { locale: 'en', children: null }, React.createElement(SendToPhotoshopDialog, {
        projectId: 'project-1',
