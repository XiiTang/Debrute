...
runtime-wide preferences, recent projects, model overrides, and secrets.
Photoshop state is ephemeral and does not enter this store. Reads and mutations use one process-local
