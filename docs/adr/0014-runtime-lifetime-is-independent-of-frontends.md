...
explicit Product Quit, a coordinated Product update, whole-Product removal, or
operating-system session termination. This was chosen over first-launcher
ownership and implicit idle shutdown so startup order cannot change product
exit semantics and background operations do not acquire hidden frontend or
timer dependencies. This decision refines the client boundary established by
