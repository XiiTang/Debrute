...
Working Copies protect the narrow unsaved text and feedback values; other
frontend presentation state is disposable. This keeps recovery proportional to
a local single-machine application rather than implementing distributed
