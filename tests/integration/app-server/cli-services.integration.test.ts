...
import { createAudioModelCatalog, createImageModelCatalog, createVideoModelCatalog } from '@debrute/capability-runtime';
import {
...
describe('app-server CLI services', () => {
    ...
    it('initializes projects only through the explicit CLI init method', async () => {
      ...
      try {
        ...
        expect((server as unknown as {
          fileWatchHandle?: unknown;
        }).fileWatchHandle).toBeUndefined();
